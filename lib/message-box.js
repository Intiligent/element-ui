...
var render = function() {
  ...
  return _c("transition", { attrs: { name: "messagebox-fade" } }, [
    _c(
      "div",
      {
        directives: [
      ...
      [
        _c(
          "div",
          { staticClass: "el-message-box", class: _vm.messageboxClassName },
          [
            _vm.title !== null
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    messageboxClassName: function messageboxClassName() {
      var className = [this.customClass];
      if (this.center) {
